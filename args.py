...
def get_args():
    ...
    parser.add_argument('--data_path', default='/home/gfloto/bio/wearable/data', help='train dataset, either odo or damage')
    ...
    parser.add_argument('--early_stop', default=10, help='early stop training')
